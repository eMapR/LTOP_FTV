...
var lt_years = lt_output.select('LandTrendr').arraySlice(0, 0, 1).arrayProject([1]);

...
Export.image.toAsset({
  ...
  assetId:asset_folder+'/LTOP_annual_segment_length_'+place, 
  region:aoi, 
  scale:30, 
  maxPixels:1e13
...
var timeSince = lt_years.subtract(fillSegmentYear(lt_output, 1990, 2021,[])); 
