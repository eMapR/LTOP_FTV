...
// var abstract_output03_1 = abstractSampler03_1(annualSRcollection,kmeans_output02[0]); 
...
var snicPts = ltop.pixelsToPts(SNICmeansImg,aoi,num_rand_feats); 
//do the sampling
//this seems to be working ok but the band naming structure is different than the one generated from QGIS
snicPts = ltop.samplePts(snicPts,SNICimagery); 

Export.table.toAsset({
              collection: snicPts, 
              description:"LTOP_snic_pts_"+place+"_c2_"+str_start, 
              assetId:"users/ak_glaciers/"+place+"_LTOP_assets/LTOP_snic_pts_"+place+"_c2_no_project"+str_start, 
              
  }); 
  
Export.image.toAsset({
              image: SNICimagery, 
              description:"LTOP_snic_imagery_"+place+"_c2_"+str_start, 
              assetId:"users/ak_glaciers/"+place+"_LTOP_assets/LTOP_snic_imagery_"+place+"_c2_no_project"+str_start, 
              region:aoi, 
              scale:30,
              maxPixels:1e13, 
  }); 
...
function kmeans02 (snicPts,SNICimagery){
  ...
  Export.image.toAsset({
              ...
              assetId:"LTOP_kmeans_cluster_image_"+place+"_c2_"+str_start, 
              region:aoi, 
              scale:30,
              maxPixels:1e13, 
  }); 
