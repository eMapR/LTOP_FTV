...
//prepend a one - when we take deltas of deltas to get the years it changed everything shifts by a year. 
...
// Map.addLayer(changeYrs.arrayGet(pos_of_max),{},'get test')
...
var maxChangeYrs_img = array_to_img(max_yod,'end_year'); 
print(maxChangeYrs_img)
//combine the two images
maxChange_img = maxChange_img.addBands(maxChangeYrs_img); 
print(maxChange_img)
