...
print('- This version (0.2.0) does NOT use the Roy coefficients');
...
var checkLTArray = function(array){
//////////
//////////
...
exports.getChangeMap = function(lt, changeParams){
  ...
  */
  ...
  //check that the 4xn array from LT has all the consecutive years you expect to see
  //COME BACK
  //lt = checkLTArray()
