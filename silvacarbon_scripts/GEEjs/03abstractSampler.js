...
var table = ee.FeatureCollection("users/ak_glaciers/LTOP_guatemala_kmeans_cluster_ids_1990_start_subsetted")
...
function main () {
  ...
  var annualSRcollection = ltgee.buildSRcollection(start_year, end_year, startDate, endDate, points,maskThese)
  ...
  // Run the extraction
  var extraction_results = run_extraction(images, points, startYear, endYear);
  ...
  Export.table.toDrive({
    collection: outputs, 
    description: "LTOP_"+place+"_Abstract_Sample_annualSRcollection_NBRTCWTCGNDVIB5_c2_1990_start", 
    fileNamePrefix: "LTOP_"+place+"_Abstract_Sample_annualSRcollection_NBRTCWTCGNDVIB5_c2_1990_start", 
    folder:place+'_abstract_image',
    fileFormat: 'csv'
  });
