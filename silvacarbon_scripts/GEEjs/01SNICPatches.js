...
Export.image.toDrive({
        ...
        description: place+'_SNIC_c2_'+start_year+'_start_date_'+startDate+'_end_date_'+end_date, 
        folder:place+'_SNIC_c2_'+start_year, 
        fileNamePrefix: place+'_SNIC_c2_'+start_year+'_start_date_'+startDate+'_end_date_'+end_date, 
        region:aoi, 
        scale:30, 
        maxPixels: 1e13 
      })     
