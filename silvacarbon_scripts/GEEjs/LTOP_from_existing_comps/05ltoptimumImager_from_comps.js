...
// landsat surface reflactance image collection from SERVIR composites
...
Export.image.toAsset({
  image: lt_vert,
  description: 'Optimized_LandTrendr_year_vert_array_from_comps',
  assetId: 'Optimized_LandTrendr_year_vert_array_from_comps',
  region: aoi,
  scale: 30,
  maxPixels: 1e13
})  
